...
A backend analytics service built with **ASP.NET Core** that integrates with the public **JSONPlaceholder API** to aggregate, analyze, and expose user activity data through clean RESTful endpoints.
...
- Handles edge cases such as users with zero posts
